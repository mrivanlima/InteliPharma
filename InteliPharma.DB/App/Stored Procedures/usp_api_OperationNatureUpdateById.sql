...
CREATE   PROCEDURE App.usp_api_OperationNatureUpdateById
...
BEGIN
	...
	DECLARE @StoredProcedureName	VARCHAR(100) = 'usp_api_OperationNatureUpdateById';
	...
	BEGIN TRY
		BEGIN TRANSACTION @StoredProcedureName
			...
			UPDATE o
				SET OperationNatureName = @OperationNatureName
			FROM App.OperationNature o 
			WHERE OperationNatureId = @OperationNatureId

			PRINT CONCAT(@OperationNatureName, ' ', 'updated successfully!');
