...
CREATE   PROCEDURE App.usp_api_TaxCalculationDeleteById
...
BEGIN
	...
	DECLARE @StoredProcedureName	VARCHAR(100) = 'usp_api_TaxCalculationDeleteById';
	...
	BEGIN TRY
		BEGIN TRANSACTION @StoredProcedureName
			...
			PRINT CONCAT(@TaxCalculationId, ' ', 'Deleted successfully!');
