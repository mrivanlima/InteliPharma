...
CREATE	PROCEDURE App.usp_api_UserMeasurementDeleteById
...
BEGIN
	...
	DECLARE @StoredProcedureName	VARCHAR(100) = 'usp_api_UserMeasurementDeleteById';
	...
	BEGIN TRY 
		BEGIN TRANSACTION @StoredProcedureName
			...
			PRINT CONCAT(@UserMeasurementId, ' ', 'Deleted Sucessfully');
