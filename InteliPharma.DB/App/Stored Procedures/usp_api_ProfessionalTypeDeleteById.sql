...
CREATE   PROCEDURE App.usp_api_ProfessionalTypeDeleteById
...
BEGIN
	...
	DECLARE @StoredProcedureName	VARCHAR(100) = 'usp_api_ProfessionalTypeDeleteById';
	...
	BEGIN TRY
		BEGIN TRANSACTION @StoredProcedureName
			...
			PRINT CONCAT(@ProfessionalTypeId, ' ', 'Deleted successfully!');
