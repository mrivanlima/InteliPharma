...
CREATE   PROCEDURE App.usp_api_TransporterDeleteById
...
BEGIN
	...
	DECLARE @StoredProcedureName	VARCHAR(100) = 'usp_api_TransporterDeleteById';
	...
	BEGIN TRY
		BEGIN TRANSACTION @StoredProcedureName
			...
			PRINT CONCAT(@TransporterId, ' ', 'Deleted successfully!');
