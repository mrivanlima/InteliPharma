...
CREATE   PROCEDURE App.usp_api_LaboratoryDeleteById
	@LaboratoryId	INT
AS
BEGIN
	...
	DECLARE @StoredProcedureName	VARCHAR(100) = 'usp_api_LaboratoryDeleteById';
	...
	BEGIN TRY
		BEGIN TRANSACTION @StoredProcedureName
			...
			PRINT CONCAT(@LaboratoryId, ' Deleted successfully!');
