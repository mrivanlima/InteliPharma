...
CREATE   PROCEDURE App.usp_api_UserStoreDeleteById
	@UserStoreId INT
AS
BEGIN
	...
	DECLARE @StoredProcedureName	VARCHAR(100) = 'usp_api_UserStoreDeleteById';
	...
	BEGIN TRY 
		BEGIN TRANSACTION @StoredProcedureName
			...
			PRINT CONCAT(@UserStoreId, ' ', 'Deleted sucessfully!');
